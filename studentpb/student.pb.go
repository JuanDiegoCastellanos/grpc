...
func (x *SetStudentReponse) Reset() {
	*x = SetStudentReponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SetStudentReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetStudentReponse) ProtoMessage() {}

func (x *SetStudentReponse) ProtoReflect() protoreflect.Message {
	mi := &file_studentpb_student_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetStudentReponse.ProtoReflect.Descriptor instead.
func (*SetStudentReponse) Descriptor() ([]byte, []int) {
	return file_studentpb_student_proto_rawDescGZIP(), []int{2}
}

func (x *SetStudentReponse) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_studentpb_student_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x23, 0x0a, 0x11, 0x53, 0x65, 0x74, 0x53,
	0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x88, 0x01,
	...
	0x64, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x12, 0x3a, 0x0a, 0x0a,
	0x53, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x12, 0x10, 0x2e, 0x73, 0x74, 0x75,
	0x64, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x1a, 0x1a, 0x2e, 0x73,
	0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x2e, 0x53, 0x65, 0x74, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e,
	0x74, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4a, 0x75, 0x61, 0x6e, 0x44, 0x69, 0x65, 0x67, 0x6f,
	0x43, 0x61, 0x73, 0x74, 0x65, 0x6c, 0x6c, 0x61, 0x6e, 0x6f, 0x73, 0x2f, 0x67, 0x72, 0x70, 0x63,
...
var file_studentpb_student_proto_goTypes = []interface{}{
	...
	(*SetStudentReponse)(nil), // 2: student.SetStudentReponse
}
var file_studentpb_student_proto_depIdxs = []int32{
	...
	2, // 3: student.StudentService.SetStudent:output_type -> student.SetStudentReponse
...
func file_studentpb_student_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_studentpb_student_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SetStudentReponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
