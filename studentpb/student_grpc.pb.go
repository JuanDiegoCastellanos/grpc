...
type StudentServiceClient interface {
	...
	SetStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*SetStudentReponse, error)
}
...
func (c *studentServiceClient) SetStudent(ctx context.Context, in *Student, opts ...grpc.CallOption) (*SetStudentReponse, error) {
	out := new(SetStudentReponse)
...
type StudentServiceServer interface {
	...
	SetStudent(context.Context, *Student) (*SetStudentReponse, error)
...
func (UnimplementedStudentServiceServer) SetStudent(context.Context, *Student) (*SetStudentReponse, error) {
